...
<body bgcolor="#171717" style="color: white; padding-left: 60px; padding-top: 20px;">
    ...
    <table cellpadding="10" style="padding-left: 200px; border-radius: 12px;">
      <tr>
        <td width="500" style="background-color: #696969; border-radius: 12px;">
          <form name="f" method="POST" action="e2.php" onsubmit="form()">
          <h3>Customer Name</h3>
          ...
          <input type="submit" name="OK" value="OK" class="n" onclick="form()">
          </form>
        </td>
            ...
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                            ...
                            <div class="product">
                                            <h2 class="text"> Movie Name: <?php echo $row["mname2"]; ?></h2>
        ...
        ?><br><br>
          ...
          <b><h3>Amount Payable: Rs.<?php echo "$total";?></h3></b>
