                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                            ...
                            <div class="product">
                                            ...
                                            <h1 style="font-size: 40px;"><?php echo $row["mname2"]; ?></h1> 
                                            <h3>Show time: <?php echo $row["mtime2"]; ?></h3><br>
    ...
    <div style="background-color: white;">
      <table border="1">
        <tr>
          ...
          <td>
            <?php
            $query = "SELECT * FROM movie2 WHERE month2='$month' && day2='$day' ORDER BY seat2 ASC ";
            $result = mysqli_query($conn,$query);
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                        
                                  <b><?php echo $row["seat2"]; ?> &nbsp&nbsp </b>
      ...
      <center><h2 style="color: white; font-family: arial;">Select seat number</h2>
...
<center>
<form method="POST" action="pay2.php" style="background-color: #e9e2e2;">  
<table id="seatsBlock">
 <p id="notification"></p>
  <tr>
