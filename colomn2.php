...
<body bgcolor="#171717">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                            ...
                            <div class="product">
                            				...
                            				<center><img class="im" src="<?php echo $row["slide2"]; ?>"></center><br>
                                            <h1 class="text"><?php echo $row["mname2"]; ?></h1> 
    ...
    <div style="color: white;">
      <form method="POST" action="ticket2.php">
    	<center><h1 style="font-family: arial;">Enter Date</h1></center><br><br>
    	...
    	<input class="n" type="submit" name="next" value="Next"></center>
      </form>
    </div>
