...
<body bgcolor="#171717">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                            ...
                            <div class="product">
                                            ...
                                            <h1 style="font-size: 40px;"><?php echo $row["mname3"]; ?></h1> 
                                            <h3>Show time: <?php echo $row["mtime3"]; ?></h3><br>
    ...
    <div style="background-color: white;">
        <table border="1">
          <tr>
            ...
            <td>
              <?php
            $query = "SELECT * FROM movie3 WHERE month3='$month' && day3='$day' ORDER BY seat3 ASC ";
            $result = mysqli_query($conn,$query);
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                        
                              <b><?php echo $row["seat3"]; ?> &nbsp&nbsp </b>
      ...
      <center><h2 style="color: white;">Select seat number</h2>
    ...
    <center>
<form method="POST" action="pay3.php" style="background-color: #e9e2e2;">  
<table id="seatsBlock">
 <p id="notification"></p>
  <tr>
